...
<template>
  <AdminLayout>
    <section class="user-management">
      ...
      <input v-model="searchQuery" placeholder="Introduce usuario o email" class="user-management__search" />
  ...
  <TransitionGroup name="list" tag="tbody">
    <tr v-for="user in filteredUsers" :key="user.uid">
      ...
      <td>{{ user.username }}</td>
      <td>{{ user.email }}</td>
      <td><span class="user-management__badge user-management__badge--active">PERMITIDO</span></td>
